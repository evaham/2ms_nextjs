!function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.effectJs = t() : e.effectJs = t()
}(this, function() {
    return function(e) {
        function t(o) {
            if (n[o])
        ...
        e.exports = {
            init: function(e) {
                ...
                return function(e) {
                    ...
                    e.node.removeAttribute("data-effectJs"),
                    e.node.removeAttribute("data-effectJs-easing"),
                    e.node.removeAttribute("data-effectJs-duration"),
                    e.node.removeAttribute("data-effectJs-delay")
                }) : (document.querySelector("body").setAttribute("data-effectJs-easing", b.easing),
                document.querySelector("body").setAttribute("data-effectJs-duration", b.duration),
                document.querySelector("body").setAttribute("data-effectJs-delay", b.delay),
                "DOMContentLoaded" === b.startEvent && ["complete", "interactive"].indexOf(document.readyState) > -1 ? v(!0) : "load" === b.startEvent ? window.addEventListener(b.startEvent, function() {
                    v(!0)
                }) : document.addEventListener(b.startEvent, function() {
                    v(!0)
                }),
                window.addEventListener("resize", (0,
                c.default)(v, b.debounceDelay, !0)),
    ...
    , , , , , function(e, t) {
        (function(t) {
            ...
            function n(e, t, n) {
                ...
                function a(e) {
                    var n = e - v;
                    return void 0 === v || n >= t || n < 0 || x && e - y >= m
                }
                function u() {
                    var e = k();
                    return a(e) ? f(e) : void (b = setTimeout(u, function(e) {
                        var n = t - (e - v);
                        return x ? w(n, m - (e - y)) : n
                    }(e)))
                }
                function f(e) {
                    return b = void 0,
                ...
                return t = r(t) || 0,
                o(n) && (g = !!n.leading,
                m = (x = "maxWait"in n) ? h(r(n.maxWait) || 0, t) : m,
            ...
            function r(e) {
                ...
                e = e.replace(s, "");
                var n = l.test(e);
                return n || m.test(e) ? p(e.slice(2), n ? 2 : 8) : d.test(e) ? u : +e
            }
    ...
    , function(e, t) {
        (function(t) {
            ...
            function i(e) {
                ...
                e = e.replace(f, "");
                var i = d.test(e);
                return i || l.test(e) ? m(e.slice(2), i ? 2 : 8) : s.test(e) ? c : +e
            }
            ...
            e.exports = function(e, t, o) {
                ...
                function u() {
                    var e = w();
                    return c(e) ? f(e) : void (b = setTimeout(u, function(e) {
                        var n = t - (e - v);
                        return x ? h(n, m - (e - y)) : n
                    }(e)))
                }
                function f(e) {
                    return b = void 0,
                ...
                return t = i(t) || 0,
                n(o) && (k = !!o.leading,
                m = (x = "maxWait"in o) ? g(i(o.maxWait) || 0, t) : m,
        ...
        function n(e) {
            e && e.forEach(function(e) {
                ...
                t.concat(n).filter(function(e) {
                    return e.hasAttribute && e.hasAttribute("data-effectJs")
                }).length && o()
            })
        }
    ...
    , function(e, t) {
        ...
        t.default = function(e, t) {
            ...
            e.forEach(function(e, i) {
                !function(e, t, n) {
                    var o = e.node.getAttribute("data-effectJs-once");
                    t > e.position ? e.node.classList.add("effectJs-animate") : void 0 !== o && ("false" === o || !n && "true" !== o) && e.node.classList.remove("effectJs-animate")
                }(e, o + n, t)
            })
        }
    }
    , function(e, t, n) {
        ...
        t.default = function(e, t) {
            return e.forEach(function(e, n) {
                e.node.classList.add("effectJs-init"),
                e.position = (0,
    ...
    , function(e, t, n) {
        ...
        t.default = function(e, t) {
            var n = 0
              ...
              , a = {
                offset: e.getAttribute("data-effectJs-offset"),
                anchor: e.getAttribute("data-effectJs-anchor"),
                anchorPlacement: e.getAttribute("data-effectJs-anchor-placement")
            };
    ...
    , function(e, t) {
        ...
        t.default = function(e) {
            return e = e || document.querySelectorAll("[data-effectJs]"),
