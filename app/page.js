    ...
    <div className="sample min-h-screen bg-[#f7f7f7] pb-20">
      ...
      <div style={{ background: "#fff382" }}>
        ...
        <div className="goods w-full">
          ...
          {/* <!--템플릿 유형 가로형 --> */}
          <ul id="" className={`goods__list goods__list--type3 grid px-0.5 py-2.5 group grid-cols-3 gap-px`}>
            {list.map((item, index) => (
              <li key={index} onClick={() => setShowPopup2(true)}>
                <div className="goods__card overflow-hidden w-full p-1 border border-[#d1d1d6] rounded-lg bg-white">
                  <div className="goods__imgbox relative flex flex-col justify-center items-center mx-auto bg-white group-[.grid-cols-2]:h-36 group-[.grid-cols-3]:h-23 group-[.grid-cols-4]:h-18" style={{ background: "white" }}>
          ...
          {/* <!--템플릿 유형 가로형 --> */}
          <ul id="" className={`goods__list goods__list--type2 grid px-0.5 py-2.5 group grid-cols-2 gap-px`}>
            {list.map((item, index) => (
              <li key={index} onClick={() => setShowPopup2(true)}>
                <div className="goods__card overflow-hidden w-full p-1 border border-[#d1d1d6] rounded-lg bg-white">
                  <div className="goods__imgbox relative flex flex-col justify-center items-center mx-auto bg-white group-[.grid-cols-2]:h-36 group-[.grid-cols-3]:h-23 group-[.grid-cols-4]:h-18" style={{ background: "white" }}>
          ...
          {/* <!--템플릿 유형 가로형  --> */}
          <ul id="" className={`goods__list grid px-0.5 py-2.5 group grid-cols-1 gap-px`}>
            {list.map((item, index) => (
              <li key={index} onClick={() => setShowPopup2(true)}>
                <div className="goods__card overflow-hidden w-full p-1 border border-[#d1d1d6] rounded-lg bg-white">
                  <div className="goods__imgbox relative flex flex-col justify-center items-center mx-auto bg-white group-[.grid-cols-2]:h-36 group-[.grid-cols-3]:h-23 group-[.grid-cols-4]:h-18" style={{ background: "white" }}>
      ...
      {showPopup && (
        <div className="layer__wrap flex justify-center items-center fixed inset-0 p-3 z-50">
          ...
          <div className="layer__panel relative overflow-hidden flex flex-col w-full p-4 bg-[#f8fafc] rounded-2xl z-50">
      ...
      {showPopup2 && (
        <div className="layer__wrap flex justify-center items-center fixed inset-0 p-3 z-50">
          ...
          <div className="layer__panel layer__panel--white relative overflow-hidden flex flex-col w-full p-4 bg-white rounded-2xl z-50">
            ...
            <div className="layer__goodsimgbox overflow-hidden flex justify-center items-center h-55 -mx-4">
            ...
            <div className="layer__goodsinfo flex flex-col">
              ...
              <button className="layer__goodsbtn flex justify-center items-center w-50 h-11 mx-auto my-4 rounded-lg text-lg text-white font-bold bg-[#f43f5e]" onClick={() => setShowPopup2(false)}>장바구니 담기</button>
            </div>
        ...
        <div className="layer__wrap flex justify-center items-center fixed inset-0 p-3 z-50">
          ...
          <div className="layer__panel layer__panel--white relative overflow-hidden flex flex-col w-full p-4 bg-white rounded-2xl z-50">
            ...
            <div className="layer__goodsinfo flex flex-col">
              ...
              <button className="layer__goodsbtn flex justify-center items-center w-50 h-11 mx-auto my-4 rounded-lg text-lg text-white font-bold bg-[#f43f5e]" onClick={() => setShowPopup3(false)}>장바구니 담기</button>
            </div>
            <button onClick={() => setShowPopup3(false)} className="layer__close absolute top-3 right-3 flex justify-center items-center">
              <svg xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 -960 960 960" width="32px" fill="#64748b"><path d="m256-236-20-20 224-224-224-224 20-20 224 224 224-224 20 20-224 224 224 224-20 20-224-224-224 224Z"></path></svg>
            </button>
          </div>
        </div>
